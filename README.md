...
```
cd existing_repo
git remote add origin https://gitlab.com/rbase/ai-pad/ai-pad-front-end.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rbase/ai-pad/ai-pad-front-end/-/settings/integrations)
